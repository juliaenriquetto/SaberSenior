...
public class Activity_20 extends ActionBarActivity implements View.OnClickListener {
    ...
    private int batman = R.drawable.kiwi;
    private int huck = R.drawable.abacaxi;
    private int rangerAzul = R.drawable.banana;
    private int goku = R.drawable.beterraba;
    private int incrivel = R.drawable.caqui;
    private int sonic = R.drawable.cereja;
    private int mario = R.drawable.framboesa;
    private int volverine = R.drawable.limao;
    private int mulhergata = R.drawable.maca;
    private int aranha = R.drawable.melancia;
